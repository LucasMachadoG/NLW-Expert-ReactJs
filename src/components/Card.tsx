...
export function Card({ note, onNoteDeleted }: CardProps){
  return(

    <Dialog.Root>
      <Dialog.Trigger className='rounded-md bg-slate-800 flex flex-col p-5 items-start gap-3 overflow-hidden relative hover:ring-2 outline-none hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
        ...
        <div className='absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-black/60 to-black/10 pointer-events-none' />
      </Dialog.Trigger>
